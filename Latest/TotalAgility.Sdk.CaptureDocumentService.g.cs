...
namespace TotalAgility.Sdk
{
    public class CaptureDocumentService
    {
        ...
        public void CreatePageFromSnippetRectangle(string sessionId, Agility.Sdk.Model.Capture.ReportingData reportingData, string documentId, Agility.Sdk.Model.Capture.RuntimeFieldCollection runtimeFields, string rectangleJson, int insertIndex) { }
